...
public class Menus implements Serializable {
    ...
    public static String categoria_escolher() {
        ...
        do {
            ...
            switch (k) {
                case 1: return "Computadores Portáteis";
                case 2: return "Computadores Desktop";
                case 3: return "Monitores";
                case 4: return "TVs";
                case 5: return "Telemóveis";
                case 6: return "Tablets";
            }
 ...
 // Menu principal que dá acesso às opções do programa
        ...
        do {
            ...
            switch (k) { 
                ...
                case 3: // Alterar o nome de um cliente.
                    ...
                    // Atualiza o nome do cliente com base no NIF (index direto na lista).
                    FileSystem.AtualizarFicheiroClientes(l.getClientes()); //atualiza a lista
                    break;

                case 4: // Alterar o email de um cliente.
                    System.out.println("nif do cliente:");
                    int z2 = Ler.umInt(); // Lê o NIF do cliente.
                    System.out.println("Novo email:");
                    l.getClientes().get(z2).setEmail(Ler.umaString()); 
                    // Atualiza o email do cliente com base no NIF (index direto na lista).
                    FileSystem.AtualizarFicheiroClientes(l.getClientes()); //atualiza a lista
                    break;
            }
        ...
        do {
            ...
            switch (k) {
                case 1: // Adicionar um produto.
                    // Ciclo para mostrar as categorias atuais dos produtos.
                    String p = "";
                    for (int i = 0; i < l.getProdutos().size(); i++) {
                        if (!p.contains(l.getProdutos().get(i).getCategoria()))
                            // Verifica se a categoria já foi adicionada à string `p`.
                            p += l.getProdutos().get(i).getCategoria();
                    }

                    // Apresenta as categorias disponíveis e pede a escolha de uma delas.
                    System.out.println("Categoria (Escolher das Atuais): " + p);
                    String s1 = Menus.categoria_escolher(); // Método externo para escolher categoria.
                    System.out.println("Nome:");
    ...
    public static void selecionar(Loja L, ArrayList<ProdutoQuantidade> prod_quant) {
        String cat=categoria_escolher(); // Lê a opção escolhida pelo utilizador.
