...
public class Menus {
	...
	public static void menu_inicial(Loja l) {
		...
		do {
			...
			k = Ler.umInt();
			ArrayList<ProdutoQuantidade> prod_quant= new ArrayList<ProdutoQuantidade>();
			switch (k) {
			case 1:
				menu_clientes(l);
				break;
	...
	public static void selecionarproduto(Loja L, ArrayList<ProdutoQuantidade> prod_quant, String categoria) throws ClienteException , StockException {
    	int comprar;
    	int e;
    	Cliente c;
